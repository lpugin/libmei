...
MeiAttribute* mei::SolesmesNcMixIn::getLiquescent() {
    if (!b->hasAttribute("liquescent")) {
        throw AttributeNotFoundException("liquescent");
    }
    return b->getAttribute("liquescent");
};

void mei::SolesmesNcMixIn::setLiquescent(std::string _liquescent) {
    MeiAttribute *a = new MeiAttribute("liquescent", _liquescent);
    b->addAttribute(a);
};

bool mei::SolesmesNcMixIn::hasLiquescent() {
    return b->hasAttribute("liquescent");
};

void mei::SolesmesNcMixIn::removeLiquescent() {
    b->removeAttribute("liquescent");
};

/* include <liquescentmixin> */
